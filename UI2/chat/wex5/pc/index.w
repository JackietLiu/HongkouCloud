...
<div xmlns="http://www.w3.org/1999/xhtml" xmlns:xui="http://www.justep.com/xui" xmlns:xu="http://www.xmldb.org/xupdate" component="$UI/system/components/justep/window/window" xid="window" extends="../../base/index.w"
      ...
      <tr class="x-chat-tr"> 
        <td class="x-chat-meun" xid = 'nav'> 
          <ul class="nav nav-pills nav-stacked x-chat-meun-tabs"> 
            ...
            <li class="orgManagement"> 
              <a bind-click="OrgManagementPage" href="#" title="组织管理"> 
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" src="$UI/work/org/chooseOrgActivity.w"
    status="normal" xid="chooseOrgDialog" xui:parent="window" xui:update-mode="insert"/>  
