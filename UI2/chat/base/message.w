...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:363px;left:76px;"
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      ...
      <column label="fID" name="fID" type="String" xid="xid7"></column>
  <column label="fSender" name="fSender" type="String" xid="xid8"></column>
  <column label="fImg" name="fImg" type="String" xid="xid9"></column>
  <column label="fContent" name="fContent" type="String" xid="xid10"></column>
  <column label="isOut" name="isOut" type="Boolean" xid="xid1"></column>
  <column label="fileUrl" name="fileUrl" type="String" xid="xid2"></column>
  <column label="fStyle" name="fStyle" type="String" xid="xid4"></column>
  <column label="fState" name="fState" type="String" xid="xid3"></column>
  <column label="fSenderPID" name="fSenderPID" type="String" xid="xid5"></column>
  <column label="fSenderTime" name="fSenderTime" type="String" xid="xid6"></column>
  <column label="fFileName" name="fFileName" type="String" xid="xid11"></column>
  <column label="fAttentionNum" name="fAttentionNum" type="String" xid="xid12"></column>
  <column label="fIsOwnSet" name="fIsOwnSet" type="String" xid="xid13"></column>
  <column label="fMessageText" name="fMessageText" type="String" xid="xid14"></column>
  <column label="fChecked" name="fChecked" type="String" xid="xid15"></column>
  <column label="pageUrl" name="pageUrl" type="String" xid="xid16"></column>
  <column label="pageParams" name="pageParams" type="String" xid="xid17"></column></div> 
  </div>  
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="transmitWindowDialog"
    ...
    activity="mainActivity" style="top:46px;left:28px;" onReceive="transmitWindowDialogReceive"/>  
  <div component="$UI/system/components/justep/popMenu/popMenu" class="x-popMenu"
            ...
            <ul class="x-list-template" xid="listTemplateUl1" style="margin:5px;"> 
              <li xid="li1"> 
                ...
                <div bind-if="val('fStyle') !== 'service'"> 
                  ...
                  <div class="media" bind-if="$model.isBot.get()?false:val('isOut')" bind-click="mediaClick"> 
    ...
    <div class="x-flex x-superinput-area" xid="superinputArea"> 
      ...
      <div class="x-superinput-right" xid="emojiRightBtn"> 
        <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon x-btn-emoji"
          label="" icon="iconfont icon-keyboard"> 
        ...
        <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon x-btn-voice"
          label="" icon="iconfont icon-yuyin"> 
            ...
            <div class="x-superinput-attachment container-fluid "> 
              <div class="row grid"> 
                <div class="col cell col-xs-3 col-md-2 text-center"> 
                  ...
                  <i class="iconfont icon-tupian x-file"/>  
                ...
                <div class="col cell col-xs-3 col-md-2 text-center"> 
                  ...
                  <i class="iconfont icon-webtubiaoku08 x-file"/>  
                ...
                <div class="col cell col-xs-3 col-md-2 text-center"> 
                  ...
                  <i class="iconfont icon-shiping x-file"/>  
                ...
                <div class="col cell col-xs-3 col-md-2 text-center"> 
                  ...
                  <i class="iconfont icon-wenjian x-file"/>  
