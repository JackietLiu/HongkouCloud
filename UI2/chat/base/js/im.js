define(function(require) {
	...
	var IM = {
		...
		registerUsers : function() {
			if (checkImpl()) {
				return IM.impl.registerUsers.apply(IM.impl, arguments);
			}
		},
		addFriends : function() {
			if (checkImpl()) {
				return IM.impl.addFriends.apply(IM.impl, arguments);
			}
		},
		addFriend : function() {
			if (checkImpl()) {
		...
		validateToken : function() {
			if (checkImpl()) {
				return IM.impl.validateToken.apply(IM.impl, arguments);
			}
		},
		searchText : function(peer, query, limit, offset) {
			if (checkImpl()) {
				return IM.impl.searchText.apply(IM.impl, arguments);
			}
		},
		searchFiles : function(peer, limit, offset) {
			if (checkImpl()) {
				return IM.impl.searchFiles.apply(IM.impl, arguments);
			}
		},
		call : call
	};
