...
<div xmlns="http://www.w3.org/1999/xhtml" xmlns:xui="http://www.justep.com/xui" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver"
   ...
   <div xid="div11" style="margin-top:10px;">
    <span xid="span20" style="font-weight:bolder;margin-right:22px;">创建群组</span>
    <a component="$UI/system/components/justep/button/button" class="btn btn-default btn-lg btn-only-icon " label="button" xid="createGroupBtn" icon="icon-android-contacts" style="    width: 50px;border-radius: 48px;background-color: rgb(75,115,164);    border: 0px;" onClick="createGroupBtnClick">
     <i xid="i14" class="icon-android-contacts"></i>
     <span xid="span17"></span></a> </div> 
  <div xid="div5" style="margin-top:2px;">
   <span xid="span14" style="font-weight:bolder;margin-right:10px;"><![CDATA[创建讨论组]]></span>
   <a component="$UI/system/components/justep/button/button" class="btn btn-default btn-lg btn-only-icon " label="button" xid="discussionGroupBtn" icon="icon-android-contacts" style="    width: 50px;border-radius: 48px;background-color: rgb(75,115,164);    border: 0px;" onClick="discussionGroupBtnClick">
