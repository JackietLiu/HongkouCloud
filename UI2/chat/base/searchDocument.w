...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-content  x-cards" xid="content1" style="padding: 0px; bottom: 0px;" _xid="C7384A3966E00001E875144915548C80"> 
      <div class="x-scroll o-searchDoc" component="$UI/system/components/justep/scrollView/scrollView" xid="searchDoc" autoPullUp="true" onPullUp="scrollViewPullUp" autoAppend="false">
   
   <div class="x-scroll-content" xid="div3"><div component="$UI/system/components/justep/list/list" class="x-list x-list-template" xid="list" data="data"> 
          <ul class="x-list-template list-group" xid="listTemplateUl1"> 
            <li xid="li2"> 
              <div class="media" xid="media1"> 
                <div class="media-left" xid="mediaLeft1"> 
                  <img src="" alt="" xid="image2" class="media-object o-icon" bind-attr-src="val(&quot;fImg&quot;)" /> 
                </div>  
   ...
   <div class="x-content-center x-pull-up" xid="div5">
    <span class="x-pull-up-label" xid="span3">加载更多...</span></div> </div>
  </div> 
  </div>  
