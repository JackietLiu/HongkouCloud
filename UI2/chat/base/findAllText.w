...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-content x-cards  x-scroll-view" xid="content1" _xid="C73765028B600001C53F1510180099B0"
      style="bottom: 0px;"> 
    ...
    <div xid="div3" style="top:50px;"><div class="x-scroll o-searchText" component="$UI/system/components/justep/scrollView/scrollView" xid="searchText" onPullUp="scrollViewPullUp" autoPullUp="true" autoAppend="false"> 
        <div class="x-scroll-content" xid="div6">
          <div component="$UI/system/components/justep/list/list" class="x-list x-list-template" xid="list2" data="textData" autoLoad="true"> 
