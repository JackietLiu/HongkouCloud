...
var __parent0=require('$model/UI2/testPlus/leftMenu'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='ceYfmYr';
	this._flag_='f44b7768fa9e1ede1fffa113a117f74c';
	this._wCfg_={};
	this._appCfg_={};
