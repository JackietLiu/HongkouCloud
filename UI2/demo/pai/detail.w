...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:100px;top:109px;"
    ...
    <div component="$UI/system/components/justep/data/baasData" autoLoad="true" xid="paiData" queryAction="queryPai_pictures" saveAction="savePai_pictures" url="/hongkou/hongkou" tableName="pai_pictures" idColumn="fID"><column label="fID" name="fID" type="String" xid="default1"></column>
  <column label="fFileName" name="fFileName" type="String" xid="default2"></column>
  <column label="预览地址" name="fPreviewPath" type="String" xid="default3"></column>
  <column label="下载地址" name="fDownloadPath" type="String" xid="default4"></column>
  <column label="建立时间" name="fCreateTime" type="String" xid="default5"></column>
  <column label="描述" name="fDescription" type="String" xid="default6"></column>
  <column label="地理位置" name="fAddress" type="String" xid="default7"></column>
  <column label="定位" name="fPositioning" type="String" xid="default8"></column>
  <column label="fUser" name="fUser" type="String" xid="default9"></column>
  <column label="文件大小" name="fFileSize" type="String" xid="default10"></column></div></div>  
