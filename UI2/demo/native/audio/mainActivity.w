...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window oa" class="window" component="$UI/system/components/justep/window/window" design="device:m;">  
      ...
      <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
        ...
        <div class="x-panel-content" xid="content3"> 
          <div component="$UI/system/components/justep/controlGroup/controlGroup"
            ...
            <div xid="div8"> 
              <a component="$UI/system/components/justep/button/button" class="btn x-yellow device-button-white"
                label="播放音乐" xid="playBtn" onClick="playBtnClick"> 
                <i xid="i5"/>  
  ...
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver"
    ...
    <div class="x-popOver-content" xid="div6" style="width:200px;"> 
      <div xid="loaddiv" style="text-align:center;height:60px;"> 
      ...
      <div xid="div10" style="text-align:center;padding-bottom:180px;"> 
        <img src="stop.png" alt="" xid="pauseImage" width="75px"
